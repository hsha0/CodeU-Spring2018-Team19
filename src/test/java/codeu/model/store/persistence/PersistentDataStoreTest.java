...
public class PersistentDataStoreTest {
  ...
  @Test
  public void testSaveAndLoadSingleUserById() throws PersistentDataStoreException {
    UUID idOne = UUID.randomUUID();
    String nameOne = "test_username_one";
    Instant creationOne = Instant.ofEpochMilli(1000);
    User inputUserOne = new User(idOne, nameOne, "test_password", creationOne);
    ...
    @Test
    public void testSaveAndLoadSingleUserByName() throws PersistentDataStoreException {
        UUID idOne = UUID.randomUUID();
        String nameOne = "test_username_one";
        Instant creationOne = Instant.ofEpochMilli(1000);
        User inputUserOne = new User(idOne, nameOne, "test_password", creationOne);
        ...
        // load
        User resultUserOne = persistentDataStore.loadUser(nameOne);
        User resultUserTwo = persistentDataStore.loadUser(nameTwo);
